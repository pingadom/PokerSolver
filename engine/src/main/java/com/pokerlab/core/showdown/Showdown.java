...
public final class Showdown {
    ...
    public static ShowdownResult compare(
            List<Card> heroHoleCards, List<Card> villainHoleCards, List<Card> boardCards) {
    ...
    private static void validateSize(String name, List<Card> cards, int expectedSize) {
        if (cards == null || cards.size() != expectedSize) {
            throw new IllegalArgumentException(
                    name + " must contain exactly " + expectedSize + " cards");
        }
    }
