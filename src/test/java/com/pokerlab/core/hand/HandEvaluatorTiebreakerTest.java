...
class HandEvaluatorTiebreakerTest {
    ...
    void higherTopTwoPairBeatsLowerTopTwoPair() {
        EvaluatedHand acesAndKings = HandEvaluator.evaluateFive(cards("As", "Ah", "Kd", "Kc", "2s"));
        EvaluatedHand kingsAndQueens = HandEvaluator.evaluateFive(cards("Ks", "Kh", "Qd", "Qc", "As"));
    ...
    void flushVersusFlushUsesHighestCardThenNextKickers() {
        EvaluatedHand aceHighFlush = HandEvaluator.evaluateFive(cards("As", "Js", "9s", "6s", "2s"));
        EvaluatedHand kingHighFlush = HandEvaluator.evaluateFive(cards("Kh", "Jh", "9h", "6h", "2h"));
    ...
    void fullHouseWithSameTripsComparesPairRankSecond() {
        EvaluatedHand acesFullOfKings = HandEvaluator.evaluateFive(cards("As", "Ah", "Ad", "Kc", "Kd"));
        EvaluatedHand acesFullOfQueens = HandEvaluator.evaluateFive(cards("Ac", "As", "Ah", "Qc", "Qd"));
